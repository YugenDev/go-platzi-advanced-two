...
func (repo *PostgresRepository) InsertPost(ctx context.Context, post *models.Posts) error {
...
func (repo *PostgresRepository) GetPostById(ctx context.Context, id string) (*models.Posts, error) {
...
func (repo *PostgresRepository) UpdatePost(ctx context.Context, post *models.Posts) error {
...
func (repo *PostgresRepository) ListPosts(ctx context.Context, page uint64) ([]*models.Posts, error) {
